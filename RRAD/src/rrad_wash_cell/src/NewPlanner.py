...
#still needs work, but this will eventually bypass evrything and allow for only partial path generation
#It works on this side, but the output cause godot to crash currently
    if PathPlan == 2:
        analysis = [] 
